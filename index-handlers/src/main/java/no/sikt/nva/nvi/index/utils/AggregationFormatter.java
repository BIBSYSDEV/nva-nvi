...
public final class AggregationFormatter {
  ...
  private static void addBucketNodes(
      ObjectNode aggregateNode, StringTermsAggregate stringTermsAggregate) {
  ...
  private static void addAggregations(
      ObjectNode aggregateNode, long docCount, Map<String, Aggregate> aggregateMap) {
  ...
  private static JsonNode serialize(Aggregate aggregate) {
    ...
    var aggregateNode =
        attempt(() -> JsonUtils.dtoObjectMapper.readTree(writer.toString())).orElseThrow();
