...
public enum InstitutionReportHeader {
    ...
    GLOBAL_STATUS("RAPPORTSTATUS", 20),
    PUBLICATION_CHANNEL_LEVEL_POINTS("VEKTINGSTALL", 21),
    INTERNATIONAL_COLLABORATION_FACTOR("FAKTORTALL_SAMARBEID", 22),
    CREATOR_SHARE_COUNT("FORFATTERDEL", 23),
    POINTS_FOR_AFFILIATION("FORFATTERVEKT", 24);
