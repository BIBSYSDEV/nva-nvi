...
public record AllInstitutionsReport(
    URI id, NviPeriodDto period, List<InstitutionJsonReport> institutions)
  ...
  private static InstitutionJsonReport getInstitutionReport(
    ...
    return InstitutionJsonReport.from(
