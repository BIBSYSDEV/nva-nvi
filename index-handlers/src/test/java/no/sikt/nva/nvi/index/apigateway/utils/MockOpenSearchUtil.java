...
public class MockOpenSearchUtil {
  ...
  public static SearchResponse<NviCandidateIndexDocument> createSearchResponse(
    ...
    return defaultBuilder().hits(constructHitsMetadata(List.of(document))).build();
  }

  public static SearchResponse<NviCandidateIndexDocument> createSearchResponse(
      List<NviCandidateIndexDocument> documents) {
    return defaultBuilder().hits(constructHitsMetadata(documents)).build();
  }
  ...
  public static SearchResponse<NviCandidateIndexDocument> createSearchResponseWithTotal(
    ...
    return defaultBuilder()
        .hits(
            new HitsMetadata.Builder<NviCandidateIndexDocument>()
                .hits(
                    documents.stream().map(MockOpenSearchUtil::toHit).collect(Collectors.toList()))
  ...
  public static SearchResponse<NviCandidateIndexDocument> createSearchResponse(
      String aggregateName, Aggregate aggregate) {
    return defaultBuilder()
