...
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.AVDNR;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.DBH_AVDELINGSKODE;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.DBH_FAKULTETSKODE;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.DBH_INSTITUSJONSKODE;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.ETTERNAVN;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.FAKTORTALL_SAMARBEID;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.FORFATTERDEL;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.FORNAVN;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.GRUPPENR;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.INSTITUSJON;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.INSTITUSJONSNR;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.INSTITUSJON_ID;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.KVALITETSNIVAKODE;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.NVAID;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.PERSONLOPENR;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.PRINT_ISSN;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.PUBLIKASJONSFORM;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.PUBLISERINGSKANAL;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.PUBLISERINGSKANALNAVN;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.PUBLISERINGSKANALTYPE;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.PUBLISERINGSPOENG;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.RAPPORTSTATUS;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.SEKTORKODE;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.STATUS_KONTROLLERT;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.STATUS_RBO;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.TENTATIVE_PUBLISERINGSPOENG;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.TITTEL;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.UNDAVDNR;
import static no.sikt.nva.nvi.report.model.authorshares.ReportHeader.VEKTINGSTALL;
