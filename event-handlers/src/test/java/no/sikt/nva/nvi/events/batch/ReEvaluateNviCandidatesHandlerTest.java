...
class ReEvaluateNviCandidatesHandlerTest {
  ...
  private static final Environment ENVIRONMENT = forHandler(ReEvaluateNviCandidatesHandler.class);
  ...
  void shouldEmitNewEventWhenBatchIsNotComplete() {
    ...
    var expectedEmittedEvent =
        new ReEvaluateRequest(pageSize, expectedStartMarker, year, OUTPUT_TOPIC);
