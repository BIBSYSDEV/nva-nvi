  ...
  private static Map<String, AttributeValue> randomAttributeValueMap() {
    return Map.of(
        ...
        AttributeValue.builder()
            .m(Map.of("someField", AttributeValue.builder().s("someValue").build()))
            .build());
  }

  private static DynamodbStreamRecord dynamodbRecordWithStreamRecord(StreamRecord streamRecord) {
    return (DynamodbStreamRecord) new DynamodbStreamRecord().withDynamodb(streamRecord);
  }
        ...
        .withNewImage(
            Map.of(
                ...
                new com.amazonaws.services.lambda.runtime.events.models.dynamodb.AttributeValue()
                    .withS(newImageIdentifier.toString())))
        .withOldImage(
            Map.of(
                IDENTIFIER,
                new com.amazonaws.services.lambda.runtime.events.models.dynamodb.AttributeValue()
                    .withS(UUID.randomUUID().toString())));
  }
