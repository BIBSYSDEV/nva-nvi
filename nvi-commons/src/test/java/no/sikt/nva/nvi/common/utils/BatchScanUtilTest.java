...
class BatchScanUtilTest extends LocalDynamoTest {
    ...
    void shouldFetchCandidatesByGivenYearAndStartMarker() {
        ...
        var results = batchScanUtil.fetchCandidatesByYear(year, true, null, startMarker).getDatabaseEntries();
    ...
    void shouldFetchCandidatesByGivenYearAndPageSize() {
        ...
        var results = batchScanUtil.fetchCandidatesByYear(searchYear, true, pageSize, null).getDatabaseEntries();
