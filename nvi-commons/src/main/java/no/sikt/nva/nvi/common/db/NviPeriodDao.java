...
public final class NviPeriodDao extends Dao {
  ...
  public static final TableSchema<NviPeriodDao> TABLE_SCHEMA =
      TableSchema.fromClass(NviPeriodDao.class);
  ...
  public record DbNviPeriod(
    ...
    public static final class Builder {
      ...
      public DbNviPeriod build() {
        return new DbNviPeriod(
            builderId,
            builderPublishingYear,
            builderStartDate,
            builderReportingDate,
            builderCreatedBy,
            builderModifiedBy);
      }
    }
