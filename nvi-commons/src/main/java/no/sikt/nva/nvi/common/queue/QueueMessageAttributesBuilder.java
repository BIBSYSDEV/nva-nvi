...
public final class QueueMessageAttributesBuilder {
  ...
  public QueueMessageAttributesBuilder() {}

  public static QueueMessageAttributesBuilder fromCandidateIdentifier(UUID candidateIdentifier) {
    return new QueueMessageAttributesBuilder()
        .withAttribute(CANDIDATE_IDENTIFIER, candidateIdentifier.toString());
  }

  public static QueueMessageAttributesBuilder fromPublicationId(URI publicationId) {
    return new QueueMessageAttributesBuilder()
        .withAttribute(PUBLICATION_ID, publicationId.toString());
  }

  public static QueueMessageAttributesBuilder fromPublicationBucketUri(URI publicationBucketUri) {
    return new QueueMessageAttributesBuilder()
        .withAttribute(PUBLICATION_BUCKET_URI, publicationBucketUri.toString());
  }

  public QueueMessageAttributesBuilder withErrorContext(Exception cause) {
  ...
  public QueueMessageAttributesBuilder withAttribute(String key, String value) {
    putIfNotBlank(key, value);
    return this;
  }

  public Map<String, MessageAttributeValue> toMessageAttributeValues() {
