...
public final class JsonPointers {
    ...
    public static final String JSON_PTR_TOP_LEVEL_ORG = "/topLevelOrganization";
    ...
    public static final String JSON_PTR_PUBLICATION_CONTEXT_LEVEL = "/entityDescription/reference/publicationContext"
                                                                    + "/level";
